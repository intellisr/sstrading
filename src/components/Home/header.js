...
import hero from "../../images/home-fruits.png"
      ...
      <div className="max-w-7xl mx-auto lg:px-6 md:px-3">
        <div className="my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-0 xl:mt-28 flex gap-10 lg:flex-justify lg:flex flex-col lg:flex-row flex-col-reverse">
          <div className="text-center lg:text-left flex flex-col justify-center">
            ...
            <h2 className="text-black text-gradient bg-gradient-to-r from-pink to-red text-6xl font-bold xxs:text-2xl xs:text-3xl sm:text-5xl lg:text-6xl stylish-font2 ">
            Sithranjan Saranath General Trading L.L.C
            </h2>

            <p className="mt-3 font-bold text-base text-black-90 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
            Our mission is to deliver the rich flavors of Sri Lankan produce to the Middle East, ensuring freshness and satisfaction for all our clients.
            </p>
